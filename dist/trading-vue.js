/*!
 * TradingVue.JS - v1.0.2 - Thu Apr 01 2021
    ...
    init: function init() {
      ...
      this.pins[0].on('settled', function () {
        ...
        if (self.pins[1].state == 'settled') {
          _this.$emit('tool-updated', self);
        }
      });
      this.pins[1].on('settled', function () {
        _this.$emit('tool-updated', self); // Call when current tool drawing is finished
...
/* harmony default export */ const Chartvue_type_script_lang_js_ = ({
  ...
  methods: {
    ...
    update_layout: function update_layout(calc_tf) {
...
const ww$$$_namespaceObject = JSON.parse('[""]');
...
var DCEvents = /*#__PURE__*/function () {
  ...
  createClass_createClass(DCEvents, [{
    ...
    key: "add_settings_icon",
    value: function add_settings_icon() {
      var type = 'System:Settings';
      ...
      this.data.tools.push({
        type: type,
        icon: icons_namespaceObject["settings.png"]
      });
    }
  }, {
    key: "remove_settings_icon",
    value: function remove_settings_icon() {
      // TODO: Does not call Toolbar render (distr version)
      var type = 'System:Settings';
      utils.overwrite(this.data.tools, this.data.tools.filter(function (x) {
        return x.type !== type;
